...
- The compiled ordered filename/SHA-256 migration manifest has no missing, extra, reordered, or changed receipt; idempotent rerun is verified before approved production change.
