...
export async function POST(request:Request,context:{params:Promise<{id:string}>}){
  try{
    ...
    await writeAuditEvent({principal,action:"AGREEMENT_VERSION_CREATED",matterId,entityType:"agreement_version",entityId:version.id,metadata:{versionNumber:version.versionNumber,label,documentIds}});
