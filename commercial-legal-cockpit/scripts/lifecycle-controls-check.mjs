...
assert.match(workspace,/executive_snapshot_receipt_verified\(id\) receipt_integrity_verified/,"workspace reads must fail closed for receipt-less legacy snapshots");
